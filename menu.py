...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection = input("Please enter the number you would like to order.")
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                 ...
                 # Add the item name, price, and quantity to the order list
                    ...
                    print(f"{quantity} {item_name}(s) have been added to your order.")
                else:
    ...
    while True:
        ...
        match keep_ordering:
            ...
            case _:
                print("Invalid. Please type (Y)es or (N)o.")
